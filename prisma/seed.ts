...
const items: ItemSeed[] = [
  ...
  },
  {
    ...
    category: DisposalCategory.SPECIAL_DROPOFF,
    instructions: "Large scrap metal items are not accepted in curbside recycling. Take them to the ACC CHaRM facility at 1005 College Ave.",
    materialName: "Metals",
  },
  ...
  // Electronics
  {
    ...
    category: DisposalCategory.SPECIAL_DROPOFF,
    instructions: "Electronics are accepted at the ACC CHaRM facility (1005 College Ave). Do NOT place in curbside carts.",
  ...
  // Household Chemicals
  {
    ...
    instructions: "Take paint to the CHaRM facility at 1005 College Ave. Latex paint can also be dried out (mix with cat litter) and placed in the landfill cart. Oil-based paint must go to CHaRM.",
