...
const items: ItemSeed[] = [
  ...
  },
  {
    name: "Scrap Metal",
    slug: "scrap-metal",
    aliases: ["metal scraps", "old metal", "metal pieces", "iron", "steel", "wire hangers", "coat hangers", "pots and pans", "aerosol cans", "metal furniture", "metal shelving"],
    category: DisposalCategory.SPECIAL_DROPOFF,
  ...
  },
  {
    name: "Food Scraps",
    slug: "food-scraps",
    aliases: ["compost", "food waste", "kitchen scraps", "food composting", "banana peels", "coffee grounds", "egg shells", "leftovers", "spoiled food", "rotten food", "fruit scraps", "vegetable scraps", "meat scraps", "paper plates", "paper napkins", "compostable plates", "food recycling"],
    category: DisposalCategory.COMPOST,
    instructions: "Drop off food scraps at any ACC composting location — available 24/7. Locations include CHaRM (1005 College Ave), ACC Solid Waste (725 Hancock Industrial Way), ACC Landfill (5700 Lexington Rd), UGA Health Sciences Campus, and more. Anything that was once alive can be composted.",
    tips: "Accepted items include all food scraps (fruit, vegetables, meat, processed food), paper plates, paper napkins, coffee grounds, egg shells, hair, dryer lint, BPI-certified compostable products, and wax-coated cardboard. NO plastics or Styrofoam.",
    materialName: "Yard Waste",
    sourceUrl: "https://www.accgov.com/9508/Food-Scraps-Drop-Off-Program",
  },
  {
    name: "Christmas Tree",
    slug: "christmas-tree",
    aliases: ["xmas tree", "holiday tree", "live tree", "real tree", "natural tree", "pine tree", "fir tree", "christmas trees"],
    category: DisposalCategory.COMPOST,
    instructions: "Christmas trees can be recycled with your regular leaf and limb pickup. Remove all decorations, lights, tinsel, and the stand first. During the holiday season (Dec 26–Jan 15), roll-off containers are available at CHaRM (1005 College Ave), GA Square Mall, and the ACC Landfill.",
    tips: "No charge for undecorated live trees. Do not bag your tree. Artificial trees cannot be composted — donate or place in landfill cart.",
    materialName: "Yard Waste",
    sourceUrl: "https://www.accgov.com/1382/Bring-One-for-the-Chipper",
  },
  {
    name: "Furniture",
    slug: "furniture",
    aliases: ["couch", "sofa", "old couch", "desk", "table", "chair", "bookshelf", "dresser", "cabinet", "shelving", "entertainment center", "old furniture", "broken furniture", "office chair", "recliner", "loveseat", "coffee table", "end table", "nightstand"],
    category: DisposalCategory.SPECIAL_DROPOFF,
    instructions: "Schedule a bulk pickup with ACC Solid Waste at 706-613-3501 ext. 0 for large furniture items. Usable furniture can also be donated to local thrift stores (Goodwill, Habitat ReStore, Salvation Army) or brought to the CHaRM facility.",
    tips: "Bulk pickup fees are charged on a cost-of-service basis. Furniture, carpets, and other large items will NOT be collected with your regular garbage service.",
    materialName: "Appliances",
    sourceUrl: "https://www.accgov.com/6517/Automated-Collection-Rules",
  },
  {
    name: "Propane Tank",
    slug: "propane-tank",
    aliases: ["propane tanks", "propane cylinder", "gas grill tank", "BBQ tank", "camping propane", "small propane", "Coleman fuel", "butane canister", "compressed gas", "propane bottle", "1 lb propane"],
    category: DisposalCategory.SPECIAL_DROPOFF,
    instructions: "Take propane tanks to the CHaRM facility (1005 College Ave). Do NOT place in curbside recycling or landfill carts — pressurized tanks are a fire and explosion hazard in collection trucks.",
    tips: "Many hardware stores and gas stations that sell propane also accept old tanks for exchange. Never puncture or attempt to empty a propane tank yourself.",
    materialName: "Household Chemicals",
    sourceUrl: "https://www.accgov.com/6828/Items-Accepted",
  },
];
